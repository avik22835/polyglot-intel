...
metacall_load_from_file("rb", [f"{SIM}/styler.rb"])
...
# The arg type crossing the boundary is: Python str → Ruby String → Rust *const u8
print("\nLoading Rust (core.rs compiled to .so)...")
metacall_load_from_file("rs", [f"{SIM}/core.so"])
